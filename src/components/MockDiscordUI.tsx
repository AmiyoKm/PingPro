...
const MockDiscordUI = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[880px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              ...
              />
              <span className="font-medium">PingPro</span>
            </div>
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            <div className="relative">
              ...
              <p className="font-semibold text-white">PingPro</p>
        ...
        <div className="p-4">
              <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                <PlusCircle className="mx-3 text-[#b9bbbe] hover:text-white cursor-not-allowed" />
                  <input type="text" readOnly className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus:outline-none" />
